...
setupSqlPath = getPath("setup_wics.sql")
setupSqlDataPath = getPath("setupData_wics.sql")
...
strategies = {
    ...
    "single_domain_double_shot": (setupSqlScript +
                   " Which members of the club are officers? " +
                   " \nSELECT m.name, o.position\nFROM member m\nJOIN officer o ON m.member_id = o.member_id;\n " +
...
questions = [
    ...
    # "How often has Cafe Zupas been catered at events?", 
    # "Which company is hosting the next event?",
    "What is being brought for food at the next event?",
    "How many people are planning on attending the next event?",
    "What's the ratio of officers to registered members on the club?",
    "What's the most common restaurant that companies are going to cater events this year with?",
]
